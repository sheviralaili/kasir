Public Class Menu_Pelanggan
    Public id_produk, id_penjualan, id_detail, id_pelanggan As String
    Dim aksi = False
    Dim LogOut
    ...
    Sub getDetail_Penjualan()
        ...
        Else
            ...
            Else
                ...
                DataGridView1.Columns(5).HeaderText = "Tanggal Penjualan"
                DataGridView1.Columns(6).HeaderText = "Total Harga"
                DataGridView1.Columns(7).HeaderText = "Id pelanggan"
                DataGridView1.Columns(8).HeaderText = "Status"
                DataGridView1.Columns(9).HeaderText = "Nama Pelanggan"
                DataGridView1.Columns(10).HeaderText = "Alamat"
                DataGridView1.Columns(11).HeaderText = "No Telp"
                DataGridView1.Columns(12).HeaderText = "Nama Produk"
                DataGridView1.Columns(13).HeaderText = "Harga"
                DataGridView1.Columns(14).HeaderText = "Stok"
